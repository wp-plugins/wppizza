<?php
	...
	$str.="<input name='".$this->pluginSlug."[".$field."][open][]' size='2' type='text' class='wppizza-time-select' value='".$val['open']."' />";
	$str.="".__('to', $this->pluginLocale).":";
	$str.="<input name='".$this->pluginSlug."[".$field."][close][]' size='2' type='text' class='wppizza-time-select' value='".$val['close']."' />";
