	...
	*****************************************************/
		$defaultOptions = array(
			...
			'order_form'=>array(
				...
				1=>array('sort'=>1,'key'=>'cemail','lbl'=>__('Email :', $this->pluginLocale),'value'=>array(),'type'=>'email','enabled'=>true,'required'=>true,'required_on_pickup'=>true,'prefill'=>true,'onregister'=>false,'placeholder'=>false),
				2=>array('sort'=>2,'key'=>'caddress','lbl'=>__('Address :', $this->pluginLocale),'value'=>array(),'type'=>'textarea','enabled'=>true,'required'=>true,'required_on_pickup'=>false,'prefill'=>true,'onregister'=>false,'placeholder'=>false),
				3=>array('sort'=>3,'key'=>'ctel','lbl'=>__('Telephone :', $this->pluginLocale),'value'=>array(),'type'=>'text','enabled'=>true,'required'=>true,'required_on_pickup'=>true,'prefill'=>true,'onregister'=>false,'placeholder'=>false),
				4=>array('sort'=>4,'key'=>'ccomments','lbl'=>__('Comments :', $this->pluginLocale),'value'=>array(),'type'=>'textarea','enabled'=>true,'required'=>false,'required_on_pickup'=>false,'prefill'=>false,'onregister'=>false,'placeholder'=>false),
				5=>array('sort'=>5,'key'=>'ccustom1','lbl'=>__('Custom Field 1 :', $this->pluginLocale),'value'=>array(),'type'=>'text','enabled'=>false,'required'=>false,'required_on_pickup'=>false,'prefill'=>false,'onregister'=>false,'placeholder'=>false),
				6=>array('sort'=>6,'key'=>'ccustom2','lbl'=>__('Custom Field 2 :', $this->pluginLocale),'value'=>array(),'type'=>'text','enabled'=>false,'required'=>false,'required_on_pickup'=>false,'prefill'=>false,'onregister'=>false,'placeholder'=>false),
				7=>array('sort'=>7,'key'=>'ccustom3','lbl'=>__('Custom Field 3 :', $this->pluginLocale),'value'=>array(),'type'=>'text','enabled'=>false,'required'=>false,'required_on_pickup'=>false,'prefill'=>false,'onregister'=>false,'placeholder'=>false),
				8=>array('sort'=>8,'key'=>'ccustom4','lbl'=>__('Custom Field 4 :', $this->pluginLocale),'value'=>array(),'type'=>'text','enabled'=>false,'required'=>false,'required_on_pickup'=>false,'prefill'=>false,'onregister'=>false,'placeholder'=>false),
				9=>array('sort'=>9,'key'=>'ccustom5','lbl'=>__('Custom Field 5 :', $this->pluginLocale),'value'=>array(),'type'=>'text','enabled'=>false,'required'=>false,'required_on_pickup'=>false,'prefill'=>false,'onregister'=>false,'placeholder'=>false),
				10=>array('sort'=>10,'key'=>'ccustom6','lbl'=>__('Custom Field 6 :', $this->pluginLocale),'value'=>array(),'type'=>'text','enabled'=>false,'required'=>false,'required_on_pickup'=>false,'prefill'=>false,'onregister'=>false,'placeholder'=>false),
				11=>array('sort'=>11,'key'=>'ctips','lbl'=>__('Tips/Gratuities :', $this->pluginLocale),'value'=>array(),'type'=>'tips','enabled'=>false,'required'=>false,'required_on_pickup'=>false,'prefill'=>false,'onregister'=>false,'placeholder'=>false)
			),
