...
<?php
		...
		add_settings_field('items_sort_orderby', ''.__('Menu items sort order (in category):', $this->pluginLocale).'', array( $this, 'wppizza_admin_settings_input'), 'layout', 'layout', 'items_sort_orderby' );
		...
		add_settings_field('order_page_quantity_change', '<b>'.__('Enable increase/decrease of items in order form via input field/textbox', $this->pluginLocale).'</b>', array( $this, 'wppizza_admin_settings_input'), 'layout', 'layout', 'order_page_quantity_change' );
		...
		add_settings_field('minicart_max_width_active', '<b>'.__('minicart settings [if used in widget or shortcode]', $this->pluginLocale).'</b><br /><span style="color:red">'.__('could interfere with some layouts. if that is the case, using some of the options provided here with additional css declarations *might* let you get around this.', $this->pluginLocale).'</span>', array( $this, 'wppizza_admin_settings_input'), 'layout', 'layout', 'minicart_max_width_active' );
