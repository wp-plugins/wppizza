<?php
		...
		add_settings_field('use_old_admin_order_print', '<b>'.__('old style order printing', $this->pluginLocale).'</b>', array( $this, 'wppizza_admin_settings_input'), 'global', 'global', 'use_old_admin_order_print' );
