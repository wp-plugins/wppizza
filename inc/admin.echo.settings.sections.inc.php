<?php
		...
		add_settings_field('minicart_max_width_active', '<b>'.__('small cart settings [if used in widget or shortcode]', $this->pluginLocale).'</b>', array( $this, 'wppizza_admin_settings_input'), 'layout', 'layout', 'minicart_max_width_active' );
